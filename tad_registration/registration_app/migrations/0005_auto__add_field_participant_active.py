...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.active'
        db.add_column(u'registration_app_participant', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.active'
        db.delete_column(u'registration_app_participant', 'active')
