...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.ride_from_tampere'
        db.add_column(u'registration_app_participant', 'ride_from_tampere',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.ride_from_tampere'
        db.delete_column(u'registration_app_participant', 'ride_from_tampere')
    ...
    models = {
        ...
        u'registration_app.participant': {
            ...
            'participation_choice': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'registration': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['registration_app.Registration']"}),
            'ride_from_helsinki': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'ride_from_tampere': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
