...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.ride_from_helsinki'
        db.add_column(u'registration_app_participant', 'ride_from_helsinki',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.ride_from_helsinki'
        db.delete_column(u'registration_app_participant', 'ride_from_helsinki')
    ...
    models = {
        ...
        u'registration_app.participant': {
            ...
            'participation_choice': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'registration': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['registration_app.Registration']"}),
            'ride_from_helsinki': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
